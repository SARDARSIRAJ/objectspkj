...
document.write("The current date and time is: " + "<b>" + currentDate + "</b>" );

// 2. Write a program that alerts the current month in words.
// For example December
var currenMonth = currentDate.toLocaleString('default', {month: 'long'});
document.write("The current month is: " + "<b>"+ currenMonth + "</b><br>");

// 3. Write a program that alerts the first 3 letters of the current
// day, for example if today is Sunday then alert will show
// Sun
var shortDay = currentDate.toLocaleString('default', {weekday: 'long'});
document.write("Today is <b>" + shortDay.slice(0,3) + "</b><br>");
